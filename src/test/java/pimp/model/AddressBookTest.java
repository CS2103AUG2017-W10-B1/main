...
public class AddressBookTest {
    ...
    public void resetData_withDuplicatePersons_throwsAssertionError() {
        // Repeat ALICE twice
        List<Person> newPersons = Arrays.asList(new Person(TypicalPersons.ALICE), new Person(TypicalPersons.ALICE));
        List<Tag> newTags = new ArrayList<>(TypicalPersons.ALICE.getTags());
