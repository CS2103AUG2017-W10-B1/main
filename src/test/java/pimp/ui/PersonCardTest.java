...
import static pimp.ui.testutil.GuiTestAssert.assertCardDisplaysPerson;
...
public class PersonCardTest extends GuiUnitTest {
    ...
    public void display() {
        ...
        guiRobot.interact(() -> {
            personWithTags.setName(TypicalPersons.ALICE.getName());
            personWithTags.setAddress(TypicalPersons.ALICE.getAddress());
            personWithTags.setEmail(TypicalPersons.ALICE.getEmail());
            personWithTags.setPhone(TypicalPersons.ALICE.getPhone());
            personWithTags.setRemark(TypicalPersons.ALICE.getRemark());
            personWithTags.setTags(TypicalPersons.ALICE.getTags());
        });
        assertCardDisplay(personCard, personWithTags, 2);
    }
