...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() throws Exception {
        ...
        String command = " " + EditCommand.COMMAND_WORD + "  " + index.getOneBased() + "  " + NAME_DESC_BOB + "  "
                ...
                + FACEBOOK_DESC_BOB + " " + TWIITER_DESC_BOB + " " + INSTAGRAM_DESC_BOB;
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_AMY + TAG_DESC_FRIEND + FACEBOOK_DESC_AMY + TWIITER_DESC_AMY + INSTAGRAM_DESC_AMY;
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + FACEBOOK_DESC_BOB + TWIITER_DESC_BOB + INSTAGRAM_DESC_BOB;
        assertCommandFailure(command, EditCommand.MESSAGE_DUPLICATE_PERSON);
    }
