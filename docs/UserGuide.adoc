...
****
* Undoes the last `amount` of commands.
* The `amount` refers to the number of undoable commands to be undoed.
...
****
* Redoes the last `amount` of commands.
* The `amount` refers to the number of undoable commands to be reversed.
* The amount *must be a positive integer* `1, 2, 3, ...`
****
