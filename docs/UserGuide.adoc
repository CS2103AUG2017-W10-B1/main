...
The current user interface of PIMP.
image::Ui.png[width="790"]

A breakdown of the different information that a contact contains.
...
These are the more advanced commands. Functionality here is useful for the user, but is not essential to the use.
