...
The purpose of this Project Portfolio is to showcase the features that I have implemented in PIMP. Each enhancement/feature will have the follow sections: External behavior, Justification, Implementation. It
